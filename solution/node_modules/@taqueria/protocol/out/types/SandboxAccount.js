...
// out/types/SandboxAccount.ts
var SandboxAccount_exports = {};
__export(SandboxAccount_exports, {
  create: () => create2,
  from: () => from,
...
module.exports = __toCommonJS(SandboxAccount_exports);
...
var from = (input) => {
  try {
    return sandboxAccountSchema.parse(input);
  } catch (previous) {
    if (previous instanceof import_zod2.ZodError) {
      const msgs = previous.errors.reduce(
        ...
        ["SandboxAccount is invalid:"]
      );
      const validationErr = msgs.join("\n") + "\n";
      throw toParseErr(previous, validationErr);
    }
    throw toParseUnknownErr(previous, "There was a problem trying to parse a SandboxAccount.");
  }
};
...
var schemas = {
  rawSchema: sandboxAccountSchema,
  schema: sandboxAccountSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = sandboxAccountSchema;
//# sourceMappingURL=SandboxAccount.js.map