...
const index = require('./index-6f887430.js');
...
const index$2 = require('./index-b183138a.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-e2e45ff8.js'); }).then((module) => module.startStatusTap());
        }
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-da7dc0de.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
