...
import { ContractAbstraction, ContractStorageType, DefaultWalletType, SendParams } from '@taquito/taquito/dist/types/contract';
...
import { OpKind, withKind } from '@taquito/taquito/dist/types/operations/types';
import { WalletDelegateParams, WalletFailingNoopParams, WalletIncreasePaidStorageParams, WalletOriginateParams, WalletProvider, WalletTransferParams } from '@taquito/taquito/dist/types/wallet/interface';
import { OriginationWalletOperation } from '@taquito/taquito/dist/types/wallet/origination-operation';
export interface PKHOption {
    forceRefetch?: boolean;
}
export type WalletParamsWithKind = withKind<WalletTransferParams, OpKind.TRANSACTION> | withKind<WalletOriginateParams, OpKind.ORIGINATION> | withKind<WalletDelegateParams, OpKind.DELEGATION> | withKind<WalletIncreasePaidStorageParams, OpKind.INCREASE_PAID_STORAGE>;
export declare class WalletOperationBatch {
     ...
     *
     */
    send(): Promise<import("@taquito/taquito/dist/types/wallet/batch-operation").BatchWalletOperation>;
}
export declare class Wallet {
    ...
    setDelegate(params: WalletDelegateParams): {
        send: () => Promise<import("@taquito/taquito/dist/types/wallet/delegation-operation").DelegationWalletOperation>;
    };
    /**
     *
    ...
    transfer(params: WalletTransferParams): {
        send: () => Promise<import("@taquito/taquito/dist/types/wallet/transaction-operation").TransactionWalletOperation>;
    };
    /**
     *
     * @description
    ...
    increasePaidStorage(params: WalletIncreasePaidStorageParams): {
        send: () => Promise<import("@taquito/taquito/dist/types/wallet/increase-paid-storage-operation").IncreasePaidStorageWalletOperation>;
    };
    /**
     *
