import { ActivationParams, BallotParams, DelegateParams, DrainDelegateParams, IncreasePaidStorageParams, OriginateParams, ProposalsParams, RPCActivateOperation, RPCBallotOperation, RPCDelegateOperation, RPCDrainDelegateOperation, RPCIncreasePaidStorageOperation, RPCOriginationOperation, RPCProposalsOperation, RPCRegisterGlobalConstantOperation, RPCRevealOperation, RPCSmartRollupAddMessagesOperation, RPCSmartRollupOriginateOperation, RPCTransferOperation, RPCTransferTicketOperation, RPCUpdateConsensusKeyOperation, RegisterDelegateParams, RegisterGlobalConstantParams, RevealParams, SmartRollupAddMessagesParams, SmartRollupOriginateParamsWithProof, TransferParams, TransferTicketParams, UpdateConsensusKeyParams } from '@taquito/taquito/dist/types/operations/types';
