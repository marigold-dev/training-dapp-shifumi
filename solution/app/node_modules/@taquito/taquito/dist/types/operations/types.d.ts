import { BallotVote, InternalOperationResultKindEnum, MichelsonV1Expression, OpKind, OperationObject, PvmKind, TransactionOperationParameter } from '@taquito/rpc';
import { BlockIdentifier } from '@taquito/taquito/dist/types/read-provider/interface';
