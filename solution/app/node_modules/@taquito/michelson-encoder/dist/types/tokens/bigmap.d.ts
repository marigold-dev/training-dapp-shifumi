import { BigMapTokenSchema } from '@taquito/michelson-encoder/dist/types/schema/types';
import { ComparableToken, Semantic, SemanticEncoding, Token, TokenFactory, TokenValidationError } from '@taquito/michelson-encoder/dist/types/tokens/token';
/**
 *  @category Error
