import { ContractTokenSchema } from '@taquito/michelson-encoder/dist/types/schema/types';
import { SemanticEncoding, Token, TokenFactory, TokenValidationError } from '@taquito/michelson-encoder/dist/types/tokens/token';
/**
 *  @category Error
