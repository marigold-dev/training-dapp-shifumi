...
type SerovalNodeWithProperties = SerovalObjectNode | SerovalNullConstructorNode | SerovalAggregateErrorNode | SerovalErrorNode | SerovalHeadersNode;
...
export default abstract class BaseSerializerContext implements PluginAccessOptions {
    ...
    protected createFunction(parameters: string[], body: string): string;
    protected createEffectfulFunction(parameters: string[], body: string): string;
    /**
    ...
    private getStreamingAsyncIteratorFactory;
    private getBlockingAsyncIteratorFactory;
