        ...
        if (isDefined(value)) {
            if (Array.isArray(value)) {
                ...
                switch (key) {
                    ...
                    default: {
                        Object.entries(value).forEach(function (x) {
                            var _a = formatSelector(x[0], x[1]), sel = _a[0], val = _a[1];
...
function getHeaders(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, resolve(options, options.token)];
                case 1:
                    token = _a.sent();
                    return [4 /*yield*/, resolve(options, options.username)];
                case 2:
                    username = _a.sent();
                    return [4 /*yield*/, resolve(options, options.password)];
                case 3:
                    password = _a.sent();
                    return [4 /*yield*/, resolve(options, options.headers)];
                case 4:
