...
import { BeaconEvent, BeaconEventHandlerFunction, BeaconEventType } from '@airgap/beacon-dapp/dist/esm/events';
import { DappP2PTransport } from '@airgap/beacon-dapp/dist/esm/transports/DappP2PTransport';
import { DappPostMessageTransport } from '@airgap/beacon-dapp/dist/esm/transports/DappPostMessageTransport';
import { DappWalletConnectTransport } from '@airgap/beacon-dapp/dist/esm/transports/DappWalletConnectTransport';
import { BlockExplorer } from '@airgap/beacon-dapp/dist/esm/utils/block-explorer';
import { AccountInfo, AppMetadata, BeaconMessageType, Blockchain, BlockchainRequestV3, BlockchainResponseV3, BroadcastResponseOutput, ColorMode, ExtendedP2PPairingResponse, ExtendedPeerInfo, ExtendedPostMessagePairingResponse, ExtendedWalletConnectPairingResponse, Network, OperationResponseOutput, PermissionRequestV3, PermissionResponseOutput, PermissionResponseV3, RequestBroadcastInput, RequestOperationInput, RequestPermissionInput, RequestSignPayloadInput, SignPayloadResponseOutput, TransportType } from '@airgap/beacon-types';
/**
 * @publicapi
 *
...
export declare class DAppClient extends Client {
    ...
    protected setActivePeer(peer?: ExtendedPostMessagePairingResponse | ExtendedP2PPairingResponse | ExtendedWalletConnectPairingResponse): Promise<void>;
    /**
