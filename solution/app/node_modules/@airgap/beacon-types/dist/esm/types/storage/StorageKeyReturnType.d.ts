import { AccountIdentifier, AccountInfo, AppMetadata, ExtendedWalletConnectPairingResponse, P2PPairingRequest, PermissionInfo, StorageKey } from '@airgap/beacon-types';
import { ExtendedP2PPairingResponse } from '@airgap/beacon-types/dist/esm/types/P2PPairingResponse';
import { PostMessagePairingRequest } from '@airgap/beacon-types/dist/esm/types/PostMessagePairingRequest';
import { ExtendedPostMessagePairingResponse } from '@airgap/beacon-types/dist/esm/types/PostMessagePairingResponse';
import { PushToken } from '@airgap/beacon-types/dist/esm/types/PushToken';
/**
 * @internalapi
 */
