...
var beaconTypes = require('@airgap/beacon-types');
if (web.isServer) {
    web.template = () => {
      return { cloneNode: () => {} }
    }
...
var beaconCore = require('@airgap/beacon-core');
var beaconTransportPostmessage = require('@airgap/beacon-transport-postmessage');
var beaconUtils = require('@airgap/beacon-utils');
...
const _tmpl$$9 = /*#__PURE__*/web.template(`<div class="loader">`);
const Loader = _ => {
  return _tmpl$$9();
};

const _tmpl$$8 = /*#__PURE__*/web.template(`<div><div><div class="alert-header"><div class="alert-logo"></div><div class="alert-button-icon"></div></div><div class="alert-modal-loading-wrapper"></div><div class="alert-body">`),
  _tmpl$2$7 = /*#__PURE__*/web.template(`<div class="alert-button-icon">`),
  _tmpl$3$6 = /*#__PURE__*/web.template(`<div class="alert-button-icon-empty">`),
  _tmpl$4$5 = /*#__PURE__*/web.template(`<div>`),
  _tmpl$5$5 = /*#__PURE__*/web.template(`<div class="alert-divider">`),
  _tmpl$6$3 = /*#__PURE__*/web.template(`<div class="alert-footer">`);
const Alert = props => {
  ...
  return (() => {
    ...
    web.insert(_el$3, (() => {
      const _c$ = web.memo(() => !!props.onBackClick);
      return () => _c$() && (() => {
        const _el$8 = _tmpl$2$7();
        web.addEventListener(_el$8, "click", props.onBackClick, true);
        web.insert(_el$8, web.createComponent(LeftIcon, {}));
        return _el$8;
      })();
    })(), _el$4);
    web.insert(_el$3, (() => {
      const _c$2 = web.memo(() => !!!props.onBackClick);
      return () => _c$2() && _tmpl$3$6();
    })(), _el$4);
    web.insert(_el$4, web.createComponent(LogoIcon, {}));
    web.addEventListener(_el$5, "click", props.onCloseClick, true);
    web.insert(_el$5, web.createComponent(CloseIcon, {}));
    web.insert(_el$6, web.createComponent(Loader, {}));
    web.insert(_el$7, () => props.content, null);
    web.insert(_el$7, !isMobile && (() => {
      const _el$10 = _tmpl$4$5();
      web.insert(_el$10, (() => {
        const _c$4 = web.memo(() => !!props.extraContent);
        return () => _c$4() && _tmpl$5$5();
      })(), null);
      web.insert(_el$10, () => props.extraContent, null);
      web.effect(() => web.className(_el$10, props.showMore ? 'alert-body-extra-show' : 'alert-body-extra-hide'));
      return _el$10;
    })(), null);
    web.insert(_el$2, (() => {
      const _c$3 = web.memo(() => !!(!isMobile && props.extraContent));
      return () => _c$3() && (() => {
        const _el$12 = _tmpl$6$3();
        _el$12.$$click = () => {
          if (props.onClickShowMore) props.onClickShowMore();
        };
        web.insert(_el$12, () => props.showMore ? 'Show less' : 'Show more');
        return _el$12;
      })();
    })(), null);
    web.effect(_p$ => {
      const _v$ = props.open ? 'alert-wrapper-show' : 'alert-wrapper-hide',
        _v$2 = props.open ? 'alert-modal-show' : 'alert-modal-hide',
        _v$3 = props.loading ? {
          opacity: 1,
...
const _tmpl$$7 = /*#__PURE__*/web.template(`<div>`),
  _tmpl$2$6 = /*#__PURE__*/web.template(`<div><div><h3></h3></div><div class="wallet-main-right"><img>`),
  _tmpl$3$5 = /*#__PURE__*/web.template(`<p>`),
  _tmpl$4$4 = /*#__PURE__*/web.template(`<div class="wallet-main-tags">`),
  _tmpl$5$4 = /*#__PURE__*/web.template(`<span class="wallet-main-tag">`),
  _tmpl$6$2 = /*#__PURE__*/web.template(`<div class="wallet-small"><img><h3>`);
const Wallet = props => {
  return (() => {
    const _el$ = _tmpl$$7();
    web.insert(_el$, (() => {
      const _c$ = web.memo(() => !!!props.small);
      return () => _c$() && (() => {
        ...
        web.addEventListener(_el$2, "click", props.onClick, true);
        web.insert(_el$4, () => props.name);
        web.insert(_el$3, (() => {
          const _c$3 = web.memo(() => !!props.description);
          return () => _c$3() && (() => {
            const _el$7 = _tmpl$3$5();
            web.insert(_el$7, () => props.description);
            return _el$7;
          })();
        })(), null);
        web.insert(_el$3, (() => {
          const _c$4 = web.memo(() => !!(props.tags && props.tags.length > 0));
          return () => _c$4() && (() => {
        ...
        web.effect(_p$ => {
          const _v$ = `wallet-main ${props.mobile ? 'wallet-main-mobile' : ''}`,
            _v$2 = `wallet-main-left ${props.mobile ? 'wallet-main-left-mobile' : ''}`,
            _v$3 = props.image;
          _v$ !== _p$._v$ && web.className(_el$2, _p$._v$ = _v$);
          _v$2 !== _p$._v$2 && web.className(_el$3, _p$._v$2 = _v$2);
          _v$3 !== _p$._v$3 && web.setAttribute(_el$6, "src", _p$._v$3 = _v$3);
          return _p$;
        }, {
          _v$: undefined,
          _v$2: undefined,
    ...
    web.insert(_el$, (() => {
      const _c$2 = web.memo(() => !!props.small);
      return () => _c$2() && (() => {
        const _el$10 = _tmpl$6$2(),
          _el$11 = _el$10.firstChild,
          _el$12 = _el$11.nextSibling;
        web.addEventListener(_el$10, "click", props.onClick, true);
        web.insert(_el$12, () => props.name);
        web.effect(() => web.setAttribute(_el$11, "src", props.image));
        return _el$10;
      })();
    })(), null);
    web.effect(() => web.className(_el$, props.disabled ? 'wallet-disabled' : ''));
    return _el$;
  })();
};
web.delegateEvents(["click"]);
...
const _tmpl$$6 = /*#__PURE__*/web.template(`<div class="top-wallets-wrapper"><div class="top-wallets-info"><h3>Connect Wallet</h3><span>If you don't have a wallet, you can select a provider and create one now. <span class="top-wallets-learn-more">Learn more</span></span></div><div class="top-wallets-wallets-main">`),
  _tmpl$2$5 = /*#__PURE__*/web.template(`<div class="top-wallets-other-wallets"><div class="top-wallets-other-wallets-left"><h3>Other Wallets</h3><p>See other wallets you can use to connect</p></div><div class="top-wallets-other-wallets-right"><img><img class="top-wallets-other-wallets-center-wallet"><img>`);
const TopWallets = props => {
  return (() => {
    const _el$ = _tmpl$$6(),
      _el$2 = _el$.firstChild,
      _el$3 = _el$2.firstChild,
    ...
    web.insert(_el$8, web.createComponent(solidJs.For, {
      ...
      children: wallet => web.createComponent(Wallet, {
        get disabled() {
    ...
    web.insert(_el$8, (() => {
      const _c$ = web.memo(() => !!props.otherWallets);
      return () => _c$() && (() => {
        const _el$9 = _tmpl$2$5(),
        ...
        web.effect(_p$ => {
          const _v$ = props.otherWallets.images[0],
            _v$2 = props.otherWallets.images[1],
            _v$3 = props.otherWallets.images[2];
          _v$ !== _p$._v$ && web.setAttribute(_el$12, "src", _p$._v$ = _v$);
          _v$2 !== _p$._v$2 && web.setAttribute(_el$13, "src", _p$._v$2 = _v$2);
          _v$3 !== _p$._v$3 && web.setAttribute(_el$14, "src", _p$._v$3 = _v$3);
          return _p$;
        }, {
          _v$: undefined,
          _v$2: undefined,
...
const _tmpl$$5 = /*#__PURE__*/web.template(`<div class="wallets-list-main-wrapper"><div class="wallets-list-wrapper"></div><button class="wallets-button">`);
const Wallets = props => {
  return (() => {
    const _el$ = _tmpl$$5(),
      _el$2 = _el$.firstChild,
    ...
    web.insert(_el$3, () => props.isMobile ? 'Pair wallet on another device' : 'Show QR code');
    return _el$;
  })();
};
web.delegateEvents(["click"]);
...
const _tmpl$$4 = /*#__PURE__*/web.template(`<div><h3 class="info-title"></h3><div class="info-buttons">`),
  _tmpl$2$4 = /*#__PURE__*/web.template(`<div>`),
  _tmpl$3$4 = /*#__PURE__*/web.template(`<div class="info-description">`),
  _tmpl$4$3 = /*#__PURE__*/web.template(`<pre class="info-data">`),
  _tmpl$5$3 = /*#__PURE__*/web.template(`<button>`);
const Info = props => {
  return (() => {
    const _el$ = _tmpl$$4(),
      _el$2 = _el$.firstChild,
      _el$3 = _el$2.nextSibling;
    web.insert(_el$, (() => {
      const _c$ = web.memo(() => !!props.icon);
      return () => _c$() && (() => {
        const _el$4 = _tmpl$2$4();
        web.insert(_el$4, () => props.icon);
        web.effect(_p$ => {
          const _v$ = `info-icon ${props.iconBadge ? 'info-badge' : ''}`,
            _v$2 = props.bigIcon ? {
              'font-size': '3.4em'
            } : {};
          _v$ !== _p$._v$ && web.className(_el$4, _p$._v$ = _v$);
          _p$._v$2 = web.style(_el$4, _v$2, _p$._v$2);
          return _p$;
        }, {
          _v$: undefined,
          _v$2: undefined
    ...
    web.insert(_el$2, () => props.title);
    web.insert(_el$, (() => {
      const _c$2 = web.memo(() => !!props.description);
      return () => _c$2() && (() => {
    ...
    web.insert(_el$, (() => {
      const _c$3 = web.memo(() => !!props.data);
      return () => _c$3() && (() => {
        const _el$6 = _tmpl$4$3();
        web.insert(_el$6, () => props.data);
        return _el$6;
      })();
    })(), _el$3);
    web.insert(_el$3, web.createComponent(solidJs.For, {
      ...
      children: button => (() => {
        ...
        web.addEventListener(_el$7, "click", button.onClick, true);
        web.insert(_el$7, () => button.label);
        web.effect(() => web.className(_el$7, button.type !== 'secondary' ? 'info-button' : 'info-button-secondary'));
        return _el$7;
      })()
    }));
    web.effect(() => web.className(_el$, `info-wrapper ${props.border ? 'info-border' : ''}`));
    return _el$;
  })();
};
web.delegateEvents(["click"]);
...
const logger = new beaconCore.Logger('QR');
/**
 ...
 */
const getQrData = (payload, height, width) => {
...
const _tmpl$$3 = /*#__PURE__*/web.template(`<div class="qr-wrapper"><div class="qr-left"></div><div class="qr-right">`),
  _tmpl$2$3 = /*#__PURE__*/web.template(`<h3>Or scan to connect`),
  _tmpl$3$3 = /*#__PURE__*/web.template(`<span>`),
  _tmpl$4$2 = /*#__PURE__*/web.template(`<span class="qr-more-info">Learn more`),
...
const QR = props => {
  ...
  return (() => {
    const _el$ = _tmpl$$3(),
      ...
      _el$3 = _el$2.nextSibling;
    web.insert(_el$2, (() => {
      const _c$ = web.memo(() => !!!props.isMobile);
      return () => _c$() && _tmpl$2$3();
    })(), null);
    web.insert(_el$2, (() => {
      const _c$2 = web.memo(() => !!!props.isMobile);
      return () => _c$2() && (() => {
        const _el$5 = _tmpl$3$3();
        web.insert(_el$5, () => `Open ${props.walletName} Wallet on your mobile phone and scan.`);
        return _el$5;
      })();
    })(), null);
    web.insert(_el$2, (() => {
      const _c$3 = web.memo(() => !!props.isMobile);
      return () => _c$3() && (() => {
        const _el$6 = _tmpl$3$3();
        web.insert(_el$6, () => `Scan QR code with a ${props.isWalletConnect ? 'WalletConnect' : 'Beacon'}-compatible wallet.`, null);
        web.insert(_el$6, (() => {
          const _c$7 = web.memo(() => !!props.onClickLearnMore);
          return () => _c$7() && (() => {
    ...
    web.insert(_el$2, (() => {
      const _c$4 = web.memo(() => !!(!props.isMobile && props.onClickLearnMore));
      return () => _c$4() && (() => {
    ...
    web.insert(_el$3, div, null);
    web.insert(_el$3, (() => {
      const _c$5 = web.memo(() => !!copied());
      return () => _c$5() && _tmpl$5$2();
    })(), null);
    web.insert(_el$3, (() => {
      const _c$6 = web.memo(() => !!!copied());
...
function mergeWallets(wallets) {
  ...
  for (let i = 0; i < wallets.length; i++) {
    ...
    if (mergedWalletsNames.includes(wallet.name)) {
      ...
      if (!mergedWallets[index].descriptions.includes(wallet.description)) mergedWallets[index].descriptions.push(wallet.description);
...
const isTwBrowser = win => {
  var _a;
  return win && ((_a = win.ethereum) === null || _a === void 0 ? void 0 : _a.isTrust) == true;
};
const isMobileOS = win => testUserAgent(win, /(Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Mobile|Tablet|Windows Phone|SymbianOS|Kindle)/i);

let colorMode = beaconTypes.ColorMode.LIGHT;
const setColorMode = mode => {
  colorMode = mode;
};
const getColorMode = () => colorMode;

const _tmpl$$2 = /*#__PURE__*/web.template(`<div><span class="pair-other-info">Select QR Type</span><br>`),
  _tmpl$2$2 = /*#__PURE__*/web.template(`<button class="wallets-button">Beacon`),
  _tmpl$3$2 = /*#__PURE__*/web.template(`<button class="wallets-button">WalletConnect`);
const [uiState, setUiState] = solidJs.createSignal('selection');
const [hasBeacon, setHasBeacon] = solidJs.createSignal(false);
const [hasWalletConnect, setHasWalletConnect] = solidJs.createSignal(false);
const [qrData, setQrData] = solidJs.createSignal('');
const PairOther = props => {
  solidJs.onMount(() => {
  ...
  const buttonClickHandler = state => {
    if (state === 'p2p' && !!props.p2pPayload) {
      props.p2pPayload.then(payload => __awaiter(void 0, void 0, void 0, function* () {
        const serializer = new beaconCore.Serializer();
        const codeQR = yield serializer.serialize(payload);
        setQrData(codeQR);
      }));
    } else if (state === 'walletconnect' && !!props.wcPayload) {
      props.wcPayload.then(payload => __awaiter(void 0, void 0, void 0, function* () {
  ...
  return [web.memo((() => {
    const _c$ = web.memo(() => uiState() === 'selection');
    return () => _c$() && (() => {
      const _el$ = _tmpl$$2(),
        _el$2 = _el$.firstChild;
        _el$2.nextSibling;
      web.insert(_el$, (() => {
        const _c$3 = web.memo(() => !!hasBeacon());
        return () => _c$3() && (() => {
      ...
      web.insert(_el$, (() => {
        const _c$4 = web.memo(() => !!hasWalletConnect());
        return () => _c$4() && (() => {
    ...
    const _c$2 = web.memo(() => !!(uiState() !== 'selection' && !!qrData()));
    return () => _c$2() && web.createComponent(QR, {
      get isWalletConnect() {
  ...
  return new Promise(resolve => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (dispose$1 && isOpen$1()) {
      ...
      setTimeout(() => {
        ...
        if (document.getElementById('beacon-alert-wrapper')) document.getElementById('beacon-alert-wrapper').remove();
      }, 500);
    }
    resolve();
  }));
...
const openAlert = config => __awaiter(void 0, void 0, void 0, function* () {
  var _a, _b;
  setIsLoading(false);
  ...
  if (!isOpen$1()) {
    let availableExtensions = yield beaconTransportPostmessage.PostMessageTransport.getAvailableExtensions();
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const extensionsUpdatedFn = event => __awaiter(void 0, void 0, void 0, function* () {
      if (event.data === 'extensionsUpdated') {
        availableExtensions = yield beaconTransportPostmessage.PostMessageTransport.getAvailableExtensions();
        setWalletList(createWalletList());
      }
    });
    beaconCore.windowRef.addEventListener('message', extensionsUpdatedFn);
    const setDefaultPayload = () => __awaiter(void 0, void 0, void 0, function* () {
      if (config.pairingPayload) {
        const serializer = new beaconCore.Serializer();
        const codeQR = yield serializer.serialize(yield p2pPayload);
        setCodeQR(codeQR);
      }
    });
    setCurrentInfo('top-wallets');
    setCurrentWallet(undefined);
    localStorage.removeItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET);
    // Shadow root
    ...
    const createWalletList = () => {
      ...
      // is Infinity Wallet.
      .filter(wallet => !availableExtensions.some(extWallet => wallet.name === extWallet.name)).map(wallet => {
        return {
          id: wallet.key,
          key: wallet.key,
        ...
        var _a, _b;
        const link = wallet.links[(_b = (_a = config.pairingPayload) === null || _a === void 0 ? void 0 : _a.networkType) !== null && _b !== void 0 ? _b : beaconTypes.NetworkType.MAINNET];
        return {
          id: wallet.key,
          key: wallet.key,
          name: wallet.shortName,
        ...
        return {
          id: wallet.id,
          key: wallet.id,
          name: (_b = (_a = wallet.shortName) !== null && _a !== void 0 ? _a : wallet.name) !== null && _b !== void 0 ? _b : '',
      ...
      const arrangedWallets = arrangeTopWallets(mergedWallets, (_a = config.featuredWallets) !== null && _a !== void 0 ? _a : defaultWalletList);
      return arrangedWallets;
    };
    setWalletList(createWalletList());
    const _isMobileOS = isMobileOS(window);
    const [isMobile, setIsMobile] = solidJs.createSignal(_isMobileOS);
    const [windowWidth, setWindowWidth] = solidJs.createSignal(window.innerWidth);
    ...
    const handleClickShowMoreContent = () => {
      var _a;
      (_a = analytics()) === null || _a === void 0 ? void 0 : _a.track('click', 'ui', 'show more wallets');
      setShowMoreContent(!showMoreContent());
    };
    const handleClickLearnMore = () => {
      var _a;
      (_a = analytics()) === null || _a === void 0 ? void 0 : _a.track('click', 'ui', 'learn more');
    ...
    const handleClickQrCode = () => {
      var _a;
      (_a = analytics()) === null || _a === void 0 ? void 0 : _a.track('click', 'ui', 'copy QR code to clipboard');
    };
    const handleCloseAlert = () => {
      closeAlert();
      beaconCore.windowRef.removeEventListener('message', extensionsUpdatedFn);
      if (config.closeButtonCallback) config.closeButtonCallback();
    };
    const handleClickWallet = id => __awaiter(void 0, void 0, void 0, function* () {
      var _c, _d, _e, _f, _g;
      if (isLoading()) return;
      setIsLoading(true);
      setShowMoreContent(false);
      ...
      if (wallet === null || wallet === void 0 ? void 0 : wallet.key) {
        ...
        localStorage.setItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET, wallet.key);
      }
      ...
      if (wallet && ((_f = wallet.supportedInteractionStandards) === null || _f === void 0 ? void 0 : _f.includes('wallet_connect'))) {
        ...
        if (config.pairingPayload) {
          ...
          if (isAndroid(window)) window.open(link, '_blank', 'noopener');else if (isIOS(window)) {
            const a = document.createElement('a');
            a.setAttribute('href', link);
            a.setAttribute('rel', 'noopener');
            a.dispatchEvent(new MouseEvent('click', {
    ...
    const handleClickOther = () => __awaiter(void 0, void 0, void 0, function* () {
      var _h;
      (_h = analytics()) === null || _h === void 0 ? void 0 : _h.track('click', 'ui', 'other wallet');
      setCurrentInfo('qr');
    });
    const handleClickConnectExtension = () => __awaiter(void 0, void 0, void 0, function* () {
      ...
      if ((_l = config.pairingPayload) === null || _l === void 0 ? void 0 : _l.postmessageSyncCode) {
        ...
        const message = {
          target: beaconTypes.ExtensionMessageTarget.EXTENSION,
          payload: postmessageCode,
          targetId: (_m = currentWallet()) === null || _m === void 0 ? void 0 : _m.id
        };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        beaconCore.windowRef.postMessage(message, beaconCore.windowRef.location.origin);
    ...
    const handleClickInstallExtension = () => __awaiter(void 0, void 0, void 0, function* () {
      var _q, _r, _s;
      (_q = analytics()) === null || _q === void 0 ? void 0 : _q.track('click', 'ui', 'install extension', {
        key: (_r = currentWallet()) === null || _r === void 0 ? void 0 : _r.key
      });
      setShowMoreContent(false);
      window.open(((_s = currentWallet()) === null || _s === void 0 ? void 0 : _s.link) || '', '_blank', 'noopener');
    });
    const handleClickOpenDesktopApp = () => __awaiter(void 0, void 0, void 0, function* () {
      var _t, _u, _v;
      setShowMoreContent(false);
      (_t = analytics()) === null || _t === void 0 ? void 0 : _t.track('click', 'ui', 'open desktop', {
    ...
    const handleClickDownloadDesktopApp = () => __awaiter(void 0, void 0, void 0, function* () {
      var _w, _x, _y;
    ...
    const hasExtension = () => {
      var _a, _b;
      return availableExtensions.map(extension => extension.id).includes(((_a = currentWallet()) === null || _a === void 0 ? void 0 : _a.firefoxId) || '') || availableExtensions.map(extension => extension.id).includes(((_b = currentWallet()) === null || _b === void 0 ? void 0 : _b.id) || '');
    };
    const colorMode = getColorMode();
    dispose$1 = web.render(() => {
      var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t;
      return (() => {
        const _el$ = _tmpl$$1();
        web.className(_el$, `theme__${colorMode}`);
        web.insert(_el$, (() => {
          const _c$ = web.memo(() => !!config.pairingPayload);
          return () => _c$() && web.createComponent(Alert, {
            get loading() {
              return isLoading();
            },
            get open() {
            ...
            get content() {
              return (() => {
                const _el$2 = _tmpl$2$1(),
                  ...
                  _el$5 = _el$4.nextSibling;
                web.insert(_el$2, (() => {
                  const _c$3 = web.memo(() => currentInfo() === 'install');
                  return () => _c$3() && (() => {
                    const _el$6 = _tmpl$$1();
                    web.insert(_el$6, (() => {
                      const _c$5 = web.memo(() => !!(!isMobile() && ((_a = currentWallet()) === null || _a === void 0 ? void 0 : _a.types.includes('extension'))));
                      return () => _c$5() && web.createComponent(Info, {
                        border: true,
                        get title() {
                          return web.memo(() => !!hasExtension())() ? `Use Browser Extension` : `Install ${(_b = currentWallet()) === null || _b === void 0 ? void 0 : _b.name} Wallet`;
                        },
                        get description() {
                          return web.memo(() => !!hasExtension())() ? `Please connect below to use your ${(_c = currentWallet()) === null || _c === void 0 ? void 0 : _c.name} Wallet browser extension.` : `To connect your ${(_d = currentWallet()) === null || _d === void 0 ? void 0 : _d.name} Wallet, install the browser extension.`;
                        },
                        get buttons() {
                          return hasExtension() ? [{
                            label: 'Connect now',
                    ...
                    web.insert(_el$6, (() => {
                      const _c$6 = web.memo(() => !!(!isMobile() && ((_e = currentWallet()) === null || _e === void 0 ? void 0 : _e.types.includes('desktop'))));
                      return () => _c$6() && web.createComponent(Info, {
                        border: true,
                    ...
                    web.insert(_el$6, (() => {
                      const _c$7 = web.memo(() => !!(!isMobile() && codeQR().length > 0 && ((_f = currentWallet()) === null || _f === void 0 ? void 0 : _f.types.includes('ios')) && ((_g = currentWallet()) === null || _g === void 0 ? void 0 : _g.types.length) > 1));
                      return () => _c$7() && web.createComponent(QR, {
                        get isWalletConnect() {
                    ...
                    web.insert(_el$6, (() => {
                      const _c$8 = web.memo(() => !!(!isMobile() && codeQR().length > 0 && ((_l = currentWallet()) === null || _l === void 0 ? void 0 : _l.types.includes('ios')) && ((_m = currentWallet()) === null || _m === void 0 ? void 0 : _m.types.length) <= 1));
                      return () => _c$8() && web.createComponent(QR, {
                        get isWalletConnect() {
                    ...
                    web.insert(_el$6, (() => {
                      const _c$9 = web.memo(() => !!(isMobile() && codeQR().length > 0));
                      return () => _c$9() && web.createComponent(QR, {
                        get isWalletConnect() {
                          return ((_s = (_r = currentWallet()) === null || _r === void 0 ? void 0 : _r.supportedInteractionStandards) === null || _s === void 0 ? void 0 : _s.includes('wallet_connect')) || false;
                        },
                        isMobile: true,
                        get walletName() {
                          return ((_t = currentWallet()) === null || _t === void 0 ? void 0 : _t.name) || 'AirGap';
                        },
                        get code() {
                          return codeQR();
                        },
                    ...
                    web.effect(_$p => web.style(_el$6, currentInfo() === 'install' || currentInfo() === 'qr' ? {
                      opacity: 1,
                      height: 'unset',
                      overflow: 'unset',
                      transform: 'scale(1)',
                ...
                web.insert(_el$2, (() => {
                  const _c$4 = web.memo(() => currentInfo() === 'qr');
                  return () => _c$4() && (() => {
                    const _el$7 = _tmpl$$1();
                    web.insert(_el$7, web.createComponent(PairOther, {
                      get walletList() {
                        return walletList();
                      },
                      onClickLearnMore: handleClickLearnMore,
                    ...
                    web.effect(_$p => web.style(_el$7, currentInfo() === 'install' || currentInfo() === 'qr' ? {
                      opacity: 1,
                      height: 'unset',
                      overflow: 'unset',
                      transform: 'scale(1)',
                ...
                web.insert(_el$3, web.createComponent(Wallets, {
                  get disabled() {
                    return isLoading();
                  },
                  get wallets() {
                    return walletList().slice(-(walletList().length - (isMobile() ? 3 : 4)));
                  },
                  get isMobile() {
                    return isMobile();
                  },
                ...
                web.insert(_el$4, web.createComponent(Info, {
                  iconBadge: true,
                  get icon() {
                    return _tmpl$3$1();
                  },
                ...
                web.insert(_el$5, web.createComponent(TopWallets, {
                  get disabled() {
                    return isLoading();
                  },
                  get wallets() {
                    return web.memo(() => !!isMobile())() ? walletList().slice(0, 3) : walletList().slice(0, 4);
                  },
                  get isMobile() {
                    return isMobile();
                  },
                ...
                web.effect(_p$ => {
                  ...
                  _p$._v$2 = web.style(_el$4, _v$2, _p$._v$2);
                  _p$._v$3 = web.style(_el$5, _v$3, _p$._v$3);
                  return _p$;
                }, {
                  _v$: undefined,
                  _v$2: undefined,
            ...
            get extraContent() {
              return web.memo(() => !!(currentInfo() !== 'top-wallets' || isMobile()))() ? undefined : web.createComponent(Wallets, {
                get disabled() {
                  return isLoading();
                },
                small: true,
            ...
            get onBackClick() {
              return web.memo(() => !!(currentInfo() === 'install' && !isMobile()))() ? () => setCurrentInfo('top-wallets') : web.memo(() => currentInfo() === 'qr')() ? () => setCurrentInfo('top-wallets') : web.memo(() => !!(currentInfo() === 'install' && isMobile()))() ? () => setCurrentInfo('wallets') : web.memo(() => !!(currentInfo() === 'wallets' && isMobile()))() ? () => setCurrentInfo('top-wallets') : currentInfo() === 'help' ? () => setCurrentInfo(previousInfo()) : undefined;
            }
          });
        })(), null);
        web.insert(_el$, (() => {
          const _c$2 = web.memo(() => !!!config.pairingPayload);
          return () => _c$2() && web.createComponent(Alert, {
            get open() {
              return isOpen$1();
            },
            get content() {
...
const _tmpl$ = /*#__PURE__*/web.template(`<img>`),
  _tmpl$2 = /*#__PURE__*/web.template(`<h3>`),
  _tmpl$3 = /*#__PURE__*/web.template(`<p class="toast-label">`),
  _tmpl$4 = /*#__PURE__*/web.template(`<div><div class="toast-header"><div class="toast-button-icon">`),
  _tmpl$5 = /*#__PURE__*/web.template(`<p class="toast-label">props.label`),
  _tmpl$6 = /*#__PURE__*/web.template(`<div class="toast-action-button">Open Wallet`),
  _tmpl$7 = /*#__PURE__*/web.template(`<div class="toast-body">`),
  _tmpl$8 = /*#__PURE__*/web.template(`<div class="toast-action-wrapper"><p>`),
  _tmpl$9 = /*#__PURE__*/web.template(`<div class="toast-action-button">`);
function parseWallet(inputString, walletInfo) {
  ...
  return parts.map(part => {
    if (part.match(regex)) {
      return [(() => {
        const _el$ = _tmpl$();
        web.effect(() => web.setAttribute(_el$, "src", walletInfo.icon));
        return _el$;
      })(), (() => {
        const _el$2 = _tmpl$2();
        web.insert(_el$2, () => walletInfo.name);
        return _el$2;
      })()];
    } else {
      return (() => {
        const _el$3 = _tmpl$3();
        web.insert(_el$3, part);
        return _el$3;
      })();
    }
  });
}
const [showMoreInfo, setShowMoreInfo] = solidJs.createSignal(true);
const Toast = props => {
  ...
  const [divPosition, setDivPosition] = solidJs.createSignal(offset);
  ...
  return (() => {
    ...
    web.insert(_el$5, web.createComponent(Loader, {}), _el$6);
    web.insert(_el$5, (() => {
      const _c$ = web.memo(() => !!(hasWalletObject && props.walletInfo));
      return () => _c$() && web.memo(() => parseWallet(props.label, props.walletInfo));
    })(), _el$6);
    web.insert(_el$5, !hasWalletObject && _tmpl$5(), _el$6);
    web.insert(_el$5, (() => {
      const _c$2 = web.memo(() => !!props.openWalletAction);
      return () => _c$2() && (() => {
        const _el$8 = _tmpl$6();
        _el$8.$$click = () => {
    ...
    web.addEventListener(_el$6, "click", props.onClickClose, true);
    web.insert(_el$6, web.createComponent(CloseIcon, {}));
    web.insert(_el$4, (() => {
      const _c$3 = web.memo(() => !!(props.actions && showMoreInfo()));
      return () => _c$3() && (() => {
        const _el$9 = _tmpl$7();
        web.insert(_el$9, web.createComponent(solidJs.For, {
          ...
          children: action => (() => {
            const _el$10 = _tmpl$8(),
              _el$11 = _el$10.firstChild;
            web.insert(_el$11, () => action.text);
            web.insert(_el$10, (() => {
              const _c$4 = web.memo(() => !!action.actionText);
              return () => _c$4() && (() => {
            ...
            web.effect(() => web.className(_el$11, `toast-action-label ${action.isBold ? 'toast-action-bold' : ''}`));
            return _el$10;
          })()
        }));
        return _el$9;
    ...
    web.effect(_p$ => {
      const _v$ = `${divPosition().x}px`,
        _v$2 = `${divPosition().y}px`,
        _v$3 = props.open ? 'toast-wrapper-show' : 'toast-wrapper-hide';
...
const [renderLast, setRenderLast] = solidJs.createSignal('');
...
const createToast = config => {
  ...
  // Loader styles
  const style2 = document.createElement('style');
  style2.textContent = styles$8;
  shadowRoot.appendChild(style2);
  // Inject font styles
  const styleFonts = document.createElement('style');
  styleFonts.textContent = "* { font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', 'Segoe UI Emoji', 'Apple Color Emoji', 'Noto Color Emoji', sans-serif;}";
  shadowRoot.appendChild(styleFonts);
  dispose = web.render(() => web.createComponent(Toast, {
    get label() {
      return config.body;
    },
    get open() {
...
const closeToast = () => new Promise(resolve => {
  ...
  setTimeout(() => {
    if (dispose) dispose();
    if (document.getElementById('beacon-toast-wrapper')) document.getElementById('beacon-toast-wrapper').remove();
    resolve();
  }, ANIMATION_TIME);
});
/**
 ...
 */
const openToast = config => __awaiter(void 0, void 0, void 0, function* () {
  if (web.isServer) {
    console.log('DO NOT RUN ON SERVER');
    return;
  }
  const id = yield beaconUtils.generateGUID();
  setRenderLast(id);
  yield closeToast();
