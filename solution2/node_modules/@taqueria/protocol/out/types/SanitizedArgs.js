...
var from = (input) => {
  try {
    return import_types_zod.sanitizedArgsSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a SanitizedArgs.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.sanitizedArgsSchema,
  schema: import_types_zod.sanitizedArgsSchema.transform((val) => val)
};
