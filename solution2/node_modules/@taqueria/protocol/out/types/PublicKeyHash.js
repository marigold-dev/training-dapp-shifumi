...
var from = (input) => {
  try {
    return import_types_zod.publicKeyHashSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PublicKeyHash.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.publicKeyHashSchema,
  schema: import_types_zod.publicKeyHashSchema.transform((val) => val)
};
