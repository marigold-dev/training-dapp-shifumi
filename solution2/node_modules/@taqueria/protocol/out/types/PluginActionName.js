...
var from = (input) => {
  try {
    return import_types_zod.pluginActionNameSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PluginActionName.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.pluginActionNameSchema,
  schema: import_types_zod.pluginActionNameSchema.transform((val) => val)
};
