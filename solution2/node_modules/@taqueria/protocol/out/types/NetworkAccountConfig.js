...
module.exports = __toCommonJS(NetworkAccountConfig_exports);
...
var from = (input) => {
  try {
    return import_types_zod.networkAccountConfigSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a NetworkAccountConfig.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.networkAccountConfigSchema,
  schema: import_types_zod.networkAccountConfigSchema.transform((val) => val)
};
