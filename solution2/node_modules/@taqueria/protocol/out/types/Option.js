...
var from = (input) => {
  try {
    return import_types_zod.optionSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Option.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.optionSchema,
  schema: import_types_zod.optionSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = import_types_zod.optionSchema;
