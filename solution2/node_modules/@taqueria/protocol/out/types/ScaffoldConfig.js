...
var from = (input) => {
  try {
    return import_types_zod.scaffoldConfigSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a ScaffoldConfig.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.scaffoldConfigSchema,
  schema: import_types_zod.scaffoldConfigSchema.transform((val) => val)
};
