...
var from = (input) => {
  try {
    return import_types_zod.pluginProxyResponseSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PluginProxyResponse.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.pluginProxyResponseSchema,
  schema: import_types_zod.pluginProxyResponseSchema.transform((val) => val)
};
