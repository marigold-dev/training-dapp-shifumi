...
var from = (input) => {
  try {
    return import_types_zod.networkConfigSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a NetworkConfig.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.networkConfigSchema,
  schema: import_types_zod.networkConfigSchema.transform((val) => val)
};
