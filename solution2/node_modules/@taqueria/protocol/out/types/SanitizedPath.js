...
var from = (input) => {
  try {
    return import_types_zod.sanitizedPathSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a SanitizedPath.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.sanitizedPathSchema,
  schema: import_types_zod.sanitizedPathSchema.transform((val) => val)
};
