...
var from = (input) => {
  try {
    return import_types_zod.proxyTaskArgsSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a ProxyTaskArgs.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.proxyTaskArgsSchema,
  schema: import_types_zod.proxyTaskArgsSchema.transform((val) => val)
};
