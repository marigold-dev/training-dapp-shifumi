...
var from = (input) => {
  try {
    return import_types_zod.contractSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Contract.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.contractSchema,
  schema: import_types_zod.contractSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = import_types_zod.contractSchema;
