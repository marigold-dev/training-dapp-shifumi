...
var from = (input) => {
  try {
    return import_types_zod.pluginSchemaSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PluginSchema.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.pluginSchemaSchema,
  schema: import_types_zod.pluginSchemaSchema.transform((val) => val)
};
