...
// out/types/RuntimeDependency.ts
var RuntimeDependency_exports = {};
__export(RuntimeDependency_exports, {
  create: () => create,
  from: () => from,
...
module.exports = __toCommonJS(RuntimeDependency_exports);
...
var from = (input) => {
  try {
    return import_types_zod.runtimeDependencySchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a RuntimeDependency.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.runtimeDependencySchema,
  schema: import_types_zod.runtimeDependencySchema.transform((val) => val)
};
