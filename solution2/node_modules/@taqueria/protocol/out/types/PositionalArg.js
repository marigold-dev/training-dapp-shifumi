...
var from = (input) => {
  try {
    return import_types_zod.positionalArgSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PositionalArg.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.positionalArgSchema,
  schema: import_types_zod.positionalArgSchema.transform((val) => val)
};
