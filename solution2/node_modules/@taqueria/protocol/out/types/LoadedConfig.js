...
var from = (input) => {
  try {
    return import_types_zod.loadedConfigSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a LoadedConfig.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.loadedConfigSchema,
  schema: import_types_zod.loadedConfigSchema.transform((val) => val)
};
