...
var from = (input) => {
  try {
    return import_types_zod.installedPluginSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a InstalledPlugin.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.installedPluginSchema,
  schema: import_types_zod.installedPluginSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = import_types_zod.installedPluginSchema;
