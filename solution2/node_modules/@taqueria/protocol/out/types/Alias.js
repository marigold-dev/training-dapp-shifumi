...
var from = (input) => {
  try {
    return import_types_zod.aliasSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Alias.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.aliasSchema,
  schema: import_types_zod.aliasSchema.transform((val) => val)
};
