...
var from = (input) => {
  try {
    return import_types_zod.versionNumberSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a VersionNumber.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.versionNumberSchema,
  schema: import_types_zod.versionNumberSchema.transform((val) => val)
};
