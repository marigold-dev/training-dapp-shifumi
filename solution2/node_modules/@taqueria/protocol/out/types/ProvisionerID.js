...
var from = (input) => {
  try {
    return import_types_zod.provisionerIDSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a ProvisionerID.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.provisionerIDSchema,
  schema: import_types_zod.provisionerIDSchema.transform((val) => val)
};
