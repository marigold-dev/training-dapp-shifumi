...
var from = (input) => {
  try {
    return import_types_zod.provisionerSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Provisioner.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.provisionerSchema,
  schema: import_types_zod.provisionerSchema.transform((val) => val)
};
