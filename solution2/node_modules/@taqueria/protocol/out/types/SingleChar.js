...
var from = (input) => {
  try {
    return import_types_zod.singleCharSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a SingleChar.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.singleCharSchema,
  schema: import_types_zod.singleCharSchema.transform((val) => val)
};
