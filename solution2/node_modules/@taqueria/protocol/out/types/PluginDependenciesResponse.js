...
var from = (input) => {
  try {
    return import_types_zod.pluginDependenciesResponseSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PluginDependenciesResponse.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.pluginDependenciesResponseSchema,
  schema: import_types_zod.pluginDependenciesResponseSchema.transform((val) => val)
};
