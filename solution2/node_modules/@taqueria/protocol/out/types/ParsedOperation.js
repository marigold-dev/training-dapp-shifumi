...
var from = (input) => {
  try {
    return import_types_zod.parsedOperationSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a ParsedOperation.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.parsedOperationSchema,
  schema: import_types_zod.parsedOperationSchema.transform((val) => val)
};
