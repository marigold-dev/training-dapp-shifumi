...
var from = (input) => {
  try {
    return import_types_zod.environmentSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Environment.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.environmentSchema,
  schema: import_types_zod.environmentSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = import_types_zod.environmentSchema;
