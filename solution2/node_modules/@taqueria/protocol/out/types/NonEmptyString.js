...
module.exports = __toCommonJS(NonEmptyString_exports);
...
var from = (input) => {
  try {
    return import_types_zod.nonEmptyStringSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a NonEmptyString.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.nonEmptyStringSchema,
  schema: import_types_zod.nonEmptyStringSchema.transform((val) => val)
};
