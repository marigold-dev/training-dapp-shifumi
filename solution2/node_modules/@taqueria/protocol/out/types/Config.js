...
var from = (input) => {
  try {
    return import_types_zod.configSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Config.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.configSchema,
  schema: import_types_zod.configSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = import_types_zod.configSchema;
