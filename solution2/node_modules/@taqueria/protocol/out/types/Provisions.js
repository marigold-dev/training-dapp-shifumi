...
var from = (input) => {
  try {
    return import_types_zod.provisionsSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Provisions.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.provisionsSchema,
  schema: import_types_zod.provisionsSchema.transform((val) => val)
};
