...
var from = (input) => {
  try {
    return import_types_zod.commandSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Command.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.commandSchema,
  schema: import_types_zod.commandSchema.transform((val) => val)
};
