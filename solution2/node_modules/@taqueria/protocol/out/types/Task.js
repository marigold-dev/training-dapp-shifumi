...
var from = (input) => {
  try {
    return import_types_zod.taskSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Task.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.taskSchema,
  schema: import_types_zod.taskSchema.transform((val) => val)
};
