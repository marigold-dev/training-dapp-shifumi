...
var from = (input) => {
  try {
    return import_types_zod.parsedTemplateSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a ParsedTemplate.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.parsedTemplateSchema,
  schema: import_types_zod.parsedTemplateSchema.transform((val) => val)
};
