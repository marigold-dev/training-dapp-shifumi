...
var BuildNumber_exports = {};
__export(BuildNumber_exports, {
  create: () => create,
  from: () => from,
...
module.exports = __toCommonJS(BuildNumber_exports);
...
var from = (input) => {
  try {
    return import_types_zod.buildNumberSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a BuildNumber.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.buildNumberSchema,
  schema: import_types_zod.buildNumberSchema.transform((val) => val)
};
