...
var RuntimeDependencyReport_exports = {};
__export(RuntimeDependencyReport_exports, {
  create: () => create,
  from: () => from,
...
module.exports = __toCommonJS(RuntimeDependencyReport_exports);
...
var from = (input) => {
  try {
    return import_types_zod.runtimeDependencyReportSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a RuntimeDependencyReport.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.runtimeDependencyReportSchema,
  schema: import_types_zod.runtimeDependencyReportSchema.transform((val) => val)
};
