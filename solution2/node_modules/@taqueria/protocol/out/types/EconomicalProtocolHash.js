...
module.exports = __toCommonJS(EconomicalProtocolHash_exports);
...
var from = (input) => {
  try {
    return import_types_zod.economicalProtocolHashSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a EconomicalProtocolHash.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.economicalProtocolHashSchema,
  schema: import_types_zod.economicalProtocolHashSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = import_types_zod.economicalProtocolHashSchema;
//# sourceMappingURL=EconomicalProtocolHash.js.map