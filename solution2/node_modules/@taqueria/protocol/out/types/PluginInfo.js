...
var from = (input) => {
  try {
    return import_types_zod.pluginInfoSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PluginInfo.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.pluginInfoSchema,
  schema: import_types_zod.pluginInfoSchema.transform((val) => val)
};
