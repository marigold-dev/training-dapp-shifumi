...
var PersistedOperation_exports = {};
__export(PersistedOperation_exports, {
  create: () => create,
  from: () => from,
...
module.exports = __toCommonJS(PersistedOperation_exports);
...
var from = (input) => {
  try {
    return import_types_zod.persistedOperationSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PersistedOperation.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.persistedOperationSchema,
  schema: import_types_zod.persistedOperationSchema.transform((val) => val)
};
