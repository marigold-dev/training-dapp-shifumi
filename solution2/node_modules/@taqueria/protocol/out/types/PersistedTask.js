...
// out/types/PersistedTask.ts
var PersistedTask_exports = {};
__export(PersistedTask_exports, {
  create: () => create,
  from: () => from,
...
module.exports = __toCommonJS(PersistedTask_exports);
...
var from = (input) => {
  try {
    return import_types_zod.persistedTaskSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PersistedTask.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.persistedTaskSchema,
  schema: import_types_zod.persistedTaskSchema.transform((val) => val)
};
