...
var from = (input) => {
  try {
    return import_types_zod.pluginJsonResponseSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PluginJsonResponse.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.pluginJsonResponseSchema,
  schema: import_types_zod.pluginJsonResponseSchema.transform((val) => val)
};
