...
var from = (input) => {
  try {
    return import_types_zod.settingsSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Settings.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.settingsSchema,
  schema: import_types_zod.settingsSchema.transform((val) => val)
};
