...
var from = (input) => {
  try {
    return import_types_zod.pluginResponseEncodingSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a PluginResponseEncoding.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.pluginResponseEncodingSchema,
  schema: import_types_zod.pluginResponseEncodingSchema.transform((val) => val)
};
