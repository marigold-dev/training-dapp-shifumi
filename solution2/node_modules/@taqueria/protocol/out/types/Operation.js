...
var from = (input) => {
  try {
    return import_types_zod.operationSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a Operation.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.operationSchema,
  schema: import_types_zod.operationSchema.transform((val) => val)
};
var rawSchema = schemas.rawSchema;
var internalSchema = import_types_zod.operationSchema;
