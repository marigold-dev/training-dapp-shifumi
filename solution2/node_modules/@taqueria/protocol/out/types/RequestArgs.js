...
var from = (input) => {
  try {
    return import_types_zod.requestArgsSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a RequestArgs.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.requestArgsSchema,
  schema: import_types_zod.requestArgsSchema.transform((val) => val)
};
