...
var from = (input) => {
  try {
    return import_types_zod.proxyTemplateArgsSchema.parse(input);
  } catch (previous) {
    ...
    throw (0, import_TaqError.toParseUnknownErr)(previous, "There was a problem trying to parse a ProxyTemplateArgs.");
  }
};
...
var schemas = {
  rawSchema: import_types_zod.proxyTemplateArgsSchema,
  schema: import_types_zod.proxyTemplateArgsSchema.transform((val) => val)
};
